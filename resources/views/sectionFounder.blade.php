<div id="FounderSection" class="w100 relative containerMin bgColor">
    <div class="grid grid2 w100 pdT50-xs pdB50-xs">
        <div class="flex alignMiddleItem justifyCenter flex-col w100 pdT100 pdB100 pdT25-xs pdB25-xs">
            <div id="founderTitle" class="w70 elemCenter">
                <h1 class="txtMiniTitle mainColor2">
                    {{__('home.founder.title')}}
                </h1>
            </div>
            <div id="founderDescription" class="w70 elemCenter pdT30 pdT15-xs">
                <p class="w100 txtNormal mainColor2">
                    {{__('home.founder.desc')}}
                </p>
            </div>
        </div>
